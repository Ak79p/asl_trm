...
#   bash eval/run_pipelines.sh -p sliding_in_boundary --auto_num_windows 5 --auto_window_size 24
#   bash eval/run_pipelines.sh --checkpoint checkpoints/exp2/best_model.pt --out_base eval/results/exp2

set -euo pipefail

# ── Defaults ─────────────────────────────────────────────────────────────────
VIDEO_DIR="data/sentence-level-stitched_1000"
CHECKPOINT="checkpoints/app/best_model.pt"
DATASET="app"
OUT_BASE="eval/results/sentence_pipelines_1000"
MIN_WORD_FRAMES=8
GAP_FRAMES=5
AUTO_NUM_WINDOWS=3
AUTO_WINDOW_SIZE=20
