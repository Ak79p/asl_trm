...
def convert_everything_to_mp4():
    cmd = 'bash start_kit/scripts/swf2mp4.sh'
    ...
    for entry in content:
        ...
        for inst in instances:
            ...
            if 'youtube' in url or 'youtu.be' in url:
                ...
                src_video_path = os.path.join('datasets/archive/videos', yt_identifier + '.mp4')
                ...
                src_video_path = os.path.join('datasets/archive/videos', video_id + '.mp4')
                dst_video_path = os.path.join('videos', video_id + '.mp4')
...
def main():
    ...
    content = json.load(open('datasets/archive/WLASL_v0.3.json'))
