...
def run(configs,
    ...
    val_dataloader = torch.utils.data.DataLoader(val_dataset, batch_size=configs.batch_size, shuffle=True, num_workers=0,
                                                 pin_memory=False, collate_fn=skip_none_collate,)
    ...
    if mode == 'flow':
        ...
        i3d.load_state_dict(torch.load('models/weights/flow_imagenet.pt'))
    else:
        i3d = InceptionI3d(400, in_channels=3)
        i3d.load_state_dict(torch.load('models/weights/rgb_imagenet.pt'))
...
if __name__ == '__main__':
    ...
    save_model = 'code/I3D/checkpoints/'
    train_split = 'code/I3D/preprocess/nslt_2000.json'

    # weights = 'archived/asl2000/FINAL_nslt_2000_iters=5104_top1=32.48_top5=57.31_top10=66.31.pt'
    weights = None
    # BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    # config_file = os.path.join(BASE_DIR, 'configs', 'asl100.ini')
    config_file = 'code/I3D/configfiles/small.ini'
