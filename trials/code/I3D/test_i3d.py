...
if __name__ == '__main__':
    ...
    train_split = 'code/I3D/preprocess/nslt_{}.json'.format(num_classes)
    weights = 'models/archived/asl2000/FINAL_nslt_2000_iters=5104_top1=32.48_top5=57.31_top10=66.31.pt'
